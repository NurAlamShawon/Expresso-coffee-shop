          ...
          <div className="items-center grid grid-cols-12 gap-2">
            ...
            <div className="col-span-7">
              <h1 className="text-xl raleway font-bold">
                Name: &nbsp;&nbsp; <span className="font-normal"> {datas.name}</span>
              </h1>
              <h1 className="text-xl raleway font-bold">
                Chef: &nbsp;&nbsp; <span className="font-normal"> {datas.chef}</span>
              </h1>
              <h1 className="text-xl raleway font-bold">
                Supplier: &nbsp;&nbsp;{" "}
              ...
              <h1 className="text-xl raleway font-bold">
                Taste: &nbsp;&nbsp;<span className="font-normal"> {datas.taste}</span>
              </h1>
              <h1 className="text-xl raleway font-bold">
                Category: &nbsp;&nbsp;{" "}
              ...
              <h1 className="text-xl raleway font-bold">
                Price: &nbsp;&nbsp; <span className="font-normal"> {datas.price}</span>
              </h1>
            </div>
          </div>
        </div>

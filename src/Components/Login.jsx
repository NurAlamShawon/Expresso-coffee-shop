...
const Login = () => {
  ...
  return (
    <div className="card bg-white  max-w-3xl shrink-0 shadow-2xl mx-auto">
      <div>
        <form className="space-y-6  m-20 " onSubmit={handlelogin}>
          ...
          <p className="hover:text-sky-700 underline cursor-pointer   hover:underline-offset-2 mb-3" onClick={handleforget}>
            Forget Password?
          </p>
          <br></br>
